...
<div class="row"> <!-- start 2nd row  -->
 ...
 <option value="{{ $subsub->id }}" {{ $subsub->id == $products->subsubcategory_id ? 'selected': '' }} >{{ $subsub->subsubcategory_name_en }}</option>	
	 ...
	 @enderror
			...
			<div class="controls">
				<input type="text" name="product_name_vi" class="form-control" required=""  value="{{ $products->product_name_vi }}">
...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	 <input type="text" name="product_tags_vi" class="form-control" value="{{ $products->product_tags_vi }}" data-role="tagsinput" required="">
	 ...
	 @enderror
			...
			<div class="controls">
	 <input type="text" name="product_size_vi" class="form-control" value="{{ $products->product_size_vi }}" data-role="tagsinput"  >
...
<div class="row"> <!-- start 5th row  -->
	 ...
	 @enderror
			...
			<div class="controls">
	 <input type="text" name="product_color_vi" class="form-control" value="{{ $products->product_color_vi }}" data-role="tagsinput" required="">
...
<div class="row"> <!-- start 7th row  -->
	...
	<textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_descp_en !!}
	     ...
	     <div class="form-group">
			<h5>Short Description Vi <span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea name="short_descp_vi" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_descp_vi !!}
	</textarea>     
	 		 </div>
		</div>
...
<div class="row"> <!-- start 8th row  -->
	...
	<textarea id="editor1" name="long_descp_en" rows="10" cols="80" required="">
		{!! $products->long_descp_en !!}
	     ...
	     <div class="form-group">
			<h5>Long Description Vi <span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea id="editor2" name="long_descp_vi" rows="10" cols="80">
		{!! $products->long_descp_vi !!}
						</textarea>       
	 		 </div>
		</div>

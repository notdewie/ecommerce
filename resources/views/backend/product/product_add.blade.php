                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_name_vi" class="form-control" required=""> </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_tags_en" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput" required=""> </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_tags_vi" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput"required=""> </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_size_en" class="form-control" value="S,M,L" data-role="tagsinput" required=""> </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_size_vi" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput" required=""> </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_color_en" class="form-control" value="Red, Green, Blue" data-role="tagsinput" required=""> </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_color_vi" class="form-control" value="Đỏ, Xanh, Vàng" data-role="tagsinput" required=""> </div>
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="file" name="product_thumbnail" class="form-control" onchange="mainThumUrl(this)" required=""> </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="editor2" name="long_descp_vi" rows="10" cols="80" required="">
                                            This is my textarea to be replaced with CKEditor.
                                        </textarea>
                                    </div>
                                        @error('short_descp_vi') 
